...
export const MESSAGES_RU: Messages = {
  ...
  received: {
    ...
    tabGuests: 'Гости',
    sourceMember: 'Участник',
    sourceGuest: 'Гость',
    filterFrom: 'С',
    filterTo: 'По',
    filterPerson: 'Кто',
    filterPersonAll: 'Любой',
    apply: 'Применить',
    empty: 'Нет взносов за выбранный период.',
    noNote: '(без заметки)',
    rangeTotal: (n: number, total: string) => `${n} взносов · всего ${total}`,
    confirmCancel: 'Отменить этот взнос?',
    newPageTitle: 'Запись платежа',
    guestPageTitle: 'Взнос гостя',
    ...
    submitMember: 'Записать платёж',
    submitGuest: 'Записать взнос',
  },
  spent: {
    title: 'Расходы',
  ...
  mini: {
    ...
    teamSection: 'Команда',
    adminSection: 'Админ',
    viewHistory: 'Денежная история',
    viewAllMembers: 'Все участники',
    confirmCancel: 'Отменить эту запись?',
    cancelledTag: 'отменено',
    statusLine: (label: string, value: string) => `${label}: ${value}`,
    saveSuccess: 'Сохранено.',
    back: '← Назад',
    recordCta: '+ Записать',
    newCta: '+ Создать',
    inviteCta: '+ Пригласить',
    archivedSuffix: ' (в архиве)',
    teamLiabilityLabel: 'Кредит участников (обязательство)',
    membersCount: (count: number) => `Участников: ${count}`,
    moreOnInfo: 'FAQ и документы',
    moreOnSettings: 'Взносы, тумбы, категории',
    moreOnGuests: 'Список гостей',
    moreOnSpendings: 'Расходы команды',
    moreOnMembers: 'Участники и балансы',
    moreOnHistory: 'Денежный поток за период',
    rangeLabel: (from: string, to: string) => `${from} → ${to}`,
    pickPeriod: 'Период',
    apply: 'Применить',
    walletEmpty: 'Нет активности в кошельке.',
    openCharges: 'Открытые долги',
    paymentHistory: 'История платежей',
    creditBalance: 'Баланс кошелька',
    cancelEntry: 'Отменить',
    inviteCopyHint: 'Нажмите, чтобы скопировать ссылку-приглашение',
    copied: 'Скопировано',
    linkPlaceholder: '—',
  },
