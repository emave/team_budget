export const MESSAGES_EN = {
  ...
  received: {
    ...
    filterTo: 'To',
    filterPerson: 'Person',
    filterPersonAll: 'Anyone',
    apply: 'Apply',
    empty: 'No deposits in this range.',
    noNote: '(no note)',
    rangeTotal: (n: number, total: string) => `${n} deposits · ${total} total`,
    confirmCancel: 'Cancel this deposit?',
    newPageTitle: 'Record payment',
    guestPageTitle: 'Guest deposit',
    ...
    submitMember: 'Record payment',
    submitGuest: 'Record deposit',
  },
  spent: {
    title: 'Expenses',
  ...
  mini: {
    ...
    inviteCta: '+ Invite',
    archivedSuffix: ' (archived)',
    teamLiabilityLabel: "Members' prepaid credit",
    membersCount: (count: number) => `${count} members`,
    moreOnInfo: 'FAQ & docs',
    moreOnSettings: 'Configure dues, pots, categories',
    moreOnGuests: 'Guest list',
    moreOnSpendings: 'Team expenses',
    moreOnMembers: 'Members & balances',
    moreOnHistory: 'Money flow over time',
    rangeLabel: (from: string, to: string) => `${from} → ${to}`,
    pickPeriod: 'Period',
    apply: 'Apply',
    walletEmpty: 'No wallet activity.',
    openCharges: 'Open debts',
    paymentHistory: 'Payment history',
    creditBalance: 'Wallet balance',
    cancelEntry: 'Cancel entry',
    inviteCopyHint: 'Tap to copy invite link',
    copied: 'Copied',
    linkPlaceholder: '—',
  },
